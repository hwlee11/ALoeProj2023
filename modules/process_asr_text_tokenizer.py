...
from modules.sentencepiece_tokenizer import create_spt_model
...
def build_spe_model(data_root,data_file):
    vocab_size = 5000 # 5000
    tokenizer = 'spe'   # spe
    spe_type = 'unigram'    # unigram
    spe_character_coverage = 1.0 # 1.0
    spe_sample_size = -1              # -1
    spe_train_extremely_large_corpus = False   # false
    spe_max_sentencepiece_length = -1        # -1
    spe_split_by_unicode_script = True          # true
    spe_bos=True
    spe_eos=True
    spe_pad =False
    lower_case = False      # false
